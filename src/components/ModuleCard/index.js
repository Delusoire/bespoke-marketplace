...
const useMetaSelector = ({ metaURL, setMetaURL, metaURLList }) => {
    ...
    const options = Object.fromEntries(metaURLList.map(metaURL => [metaURL, prettifyMeta(metaURL)]));
    ...
    return (S.React.createElement("div", { className: cardClasses },
        S.React.createElement("div", { className: "XiVwj5uoqqSFpS4cYOC6", draggable: "true" },
            ...
            S.React.createElement("div", { className: "E1N1ByPFWo4AJLHovIBQ" },
                S.React.createElement("div", { style: {
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "space-between",
                        flexDirection: "row",
                    } },
                    S.React.createElement("a", { draggable: "false", title: name, className: "Nqa6Cw3RkDMV8QnYreTr", dir: "auto", href: href, target: "_blank", rel: "noopener noreferrer", onClick: e => e.stopPropagation() },
