...
class TabBarItem extends React.ModulePage<{
...
const TabBar = React.memo<TabBarProps>(function TabBar({ links, activeLink, switchCallback, windowSize = Infinity }: TabBarProps) {
