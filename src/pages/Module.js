	...
	switch (status) {
		...
		case "success": {
			return /*#__PURE__*/ S.React.createElement(
				...
				/*#__PURE__*/ S.React.createElement("style", null, '@import "https://cdn.jsdelivr.xyz/npm/water.css@2/out/water.css";'),
	...
	return /*#__PURE__*/ S.React.createElement(
		...
		/*#__PURE__*/ S.React.createElement(
			...
			/*#__PURE__*/ S.React.createElement(
				...
				/*#__PURE__*/ S.React.createElement("h1", null, t("pages.module.title")),
			),
			/*#__PURE__*/ S.React.createElement(
				"div",
				{
				...
				!localOnly &&
					/*#__PURE__*/ S.React.createElement(
						...
						installedAndUpdated ? /*#__PURE__*/ S.React.createElement(TrashIcon, null) : /*#__PURE__*/ S.React.createElement(DownloadIcon, null),
						" ",
						label,
					),
			),
		),
		/*#__PURE__*/ S.React.createElement(RemoteMarkdown, {
			url: readmeURL,
		}),
	);
}
